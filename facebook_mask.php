...
<div id="navwrapper">
  ...
  <td><div id="button"><input type="submit" value="Log in" id="button"></div></td>
        ...
        <!--<form action="process_vulnerable.php?action=transfer" method="POST">
          <input type="hidden" name="destinatary" value="usuario">
          <input type="hidden" name="quanitty" value="1000">
          <td><div id="button"><input type="submit" value="Log In" id="button"></div></td>
  ...
  <div id="contentwrapper">
	...
	<!--<a href="#"><button style="color: black;padding: 15px;background-color: #f6f7f8; font-weight: bold; cursor: pointer;">Ir a <strong>Facebook</strong></button></a>
	<a href="http://www.facebook.com"><button style="color: white;padding: 15px;background-color: #3b5998; font-weight: bold; cursor: pointer;">Ver notificaciones</button></a>-->
